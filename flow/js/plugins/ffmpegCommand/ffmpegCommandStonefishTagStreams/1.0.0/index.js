    ...
    streams.forEach(function (stream) {
        ...
        if (['video', 'audio', 'subtitle'].includes(codecType)) {
            ...
            if (!((_b = stream.tags) === null || _b === void 0 ? void 0 : _b.title) // title is missing
                ...
                var title = (0, metadataUtils_1.generateTitle)(stream);
                ...
                (_c = stream.tags) !== null && _c !== void 0 ? _c : (stream.tags = {});
        ...
        if (setDisposition && ['audio', 'subtitle'].includes(codecType)) {
            ...
            if ((0, metadataUtils_1.isCommentary)(stream) && !((_d = stream.disposition) === null || _d === void 0 ? void 0 : _d.comment)) {
                args.jobLog("found [".concat(codecType, "] stream that requires the comment disposition flag"));
                // set shouldProcess
                args.variables.ffmpegCommand.shouldProcess = true;
                // set comment flag
                (_e = stream.disposition) !== null && _e !== void 0 ? _e : (stream.disposition = {});
            ...
            if ((0, metadataUtils_1.isDescriptive)(stream) && !((_f = stream.disposition) === null || _f === void 0 ? void 0 : _f.descriptions)) {
                args.jobLog("found [".concat(codecType, "] stream that requires the descriptions disposition flag"));
                // set shouldProcess
                args.variables.ffmpegCommand.shouldProcess = true;
                // set descriptions flag
                (_g = stream.disposition) !== null && _g !== void 0 ? _g : (stream.disposition = {});
