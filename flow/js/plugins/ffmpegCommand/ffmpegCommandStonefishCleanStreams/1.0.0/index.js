    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                keepLanguages = String(args.inputs.keepLanguages).split(',').map(function (langTag) { return langTag.trim(); });
